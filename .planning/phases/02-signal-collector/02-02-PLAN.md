...
- File contains `gsd-signal-collector` reference (confirms agent spawn is documented)
- File contains `Signal Collection Complete` or equivalent results section
- File contains `kb-rebuild-index` reference (confirms index rebuild step)
- Workflow presents structured results with severity breakdown
