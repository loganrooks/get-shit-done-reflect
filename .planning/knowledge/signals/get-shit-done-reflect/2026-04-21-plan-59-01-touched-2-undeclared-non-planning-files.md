---
id: sig-2026-04-21-plan-59-01-touched-2-undeclared-non-planning-files
type: signal
...
related_signals:
  ...
  - sig-2026-03-27-plan-04-files-modified-declared-empty-but-automati
...
confidence: medium
confidence_basis: Comparison of plan declaration against git log for commits matching (59-01); 2 extra non-planning files were touched beyond the declared files_modified set.
triage: {}
remediation: {}
verification: {}
recurrence_of: ""
...
Plan 59-01 touched 2 undeclared non-planning files beyond files_modified Supporting evidence: get-shit-done/bin/gsd-tools.cjs tests/unit/kb-schema.test.js

## Context

Phase 59, Plan 01, git range 4237da8..f1de2b0 Detection source: git-history.
