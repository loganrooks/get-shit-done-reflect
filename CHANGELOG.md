...
- **$HOME path doubling in global installs**: Fixed `replacePathsInContent()` producing `$HOME/$HOME/` paths in all workflow and command files during global install — broke all 91 GSDR files in `~/.claude/`
